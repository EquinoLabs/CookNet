  ...
  return (
    <div className="create-post-form">
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="form-row">
            ...
            <div>
              ...
              >
                ...
                <option value="easy">Asian</option>
                <option value="medium">Mexican</option>
                <option value="hard">Continental</option>
              </select>
            </div>
          </div>
        </div>
        ...
        <div className="form-section">
          <h3 className="section-title">Add Images & Videos</h3>

          <div className="media-section">
            {imagePreview ? (
              <div className="media-preview">
                <label htmlFor="upload_image">Uploaded Image</label>
              ...
              <div className="media-preview">
                <label htmlFor="upload_video">Uploaded Video</label>
                <video controls>
                  <source
